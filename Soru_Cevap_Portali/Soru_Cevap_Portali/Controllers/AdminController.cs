...
using Soru_Cevap_Portali.Repository.Abstract;
using Soru_Cevap_Portali.ViewModels;

namespace Soru_Cevap_Portali.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController( INotyfService notify, IQuestionRepository questionRepository, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, AppDbContext context, IFileProvider fileProvider)
        {
            _notify = notify;
        ...
        public async Task<IActionResult> Index(string searchString, string category)
        {
            ...
            {
                questions = questions.Where(p => p.QuestionTitle.ToLower().Contains(searchString.ToLower()));
