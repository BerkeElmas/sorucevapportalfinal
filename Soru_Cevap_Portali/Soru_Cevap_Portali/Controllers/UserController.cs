        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            if (userRoles.Any())
            {
                ...
                if (!removeRolesResult.Succeeded)
                {
                    ...
                    return BadRequest($"Roller silinemedi: {errors}");
                }
            }

            // Kullanıcıya ait cevapları ve soruları sil
            var userAnswers = user.Answers.ToList();
            if (userAnswers.Any())
            {
            ...
            var userQuestions = user.Questions.ToList();
            ...
            _notify.Success("Kullanıcı silindi.");
