...
namespace Soru_Cevap_Portali.Controllers
{
    public class AnswerController : Controller
    {
        ...
        public AnswerController( INotyfService notify, IQuestionRepository questionRepository, AppDbContext context, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
