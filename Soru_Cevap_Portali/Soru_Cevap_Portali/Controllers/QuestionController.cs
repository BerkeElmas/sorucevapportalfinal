...
namespace SoruCevapPortali.Controllers
{
    public class QuestionController : Controller
    {
        ...
        public QuestionController( INotyfService notify, IQuestionRepository questionRepository, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, AppDbContext context)
        {
            _notify = notify;
