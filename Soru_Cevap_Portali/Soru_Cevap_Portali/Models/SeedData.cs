        ...
        public static async Task IdentitySeeddata(IApplicationBuilder app)
        {
            ...
            if (!context.Questions.Any())
            {
                ...
                if (userList == null || !userList.Any())
                {
                    ...
                    {
                        new AppUser { UserName = "MesutHanci" ,FullName = "Mesut Hanci",CreatedAt = new DateTime(2024, 9, 1, 10, 30, 45),Email = "mesuthanci@gmail.com"},
                        new AppUser { UserName = "HakanDikgoz" ,FullName = "Hakan Dikgöz",CreatedAt = new DateTime(2024, 10, 5, 10, 30, 45),Email = "selman@gmail.com"},
                        new AppUser { UserName = "MesutColak" ,FullName = "Mesut Çolak",CreatedAt = new DateTime(2024, 11, 6, 10, 30, 45),Email = "mesut@gmail.com"},
                        new AppUser { UserName = "SelmaKoc" ,FullName = "Selma Koç",CreatedAt = new DateTime(2024, 12, 1, 10, 00, 45),Email = "selmakoc@gmail.com"},
                         new AppUser { UserName = "DenizEkin" ,FullName = "Deniz Ekin",CreatedAt = new DateTime(2024, 5, 1, 10, 00, 45),Email = "denizekin@gmail.com"},
                          new AppUser { UserName = "ElifAksoy" ,FullName = "Elif Aksoy",CreatedAt = new DateTime(2024, 8, 1, 11, 00, 45),Email = "elifaksoy@gmail.com"},
                ...
                var questions = new List<Question>
            {
                ...
                new Question
                {
                    QuestionTitle = "Teknolojinin hayatımızdaki rolü nedir?",
